...
from mmpose.datasets import (BottomupRandomChoiceResize, BottomupRandomCrop, LoadImage, PackPoseInputs,
                             RandomFlip, StanfordExtraDataset)
...
# codec settings
codec = dict(type=EDPoseLabel, num_select=50, num_keypoints=23)
...
dataset_type = StanfordExtraDataset
data_mode = 'bottomup'
