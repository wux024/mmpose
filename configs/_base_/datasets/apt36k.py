dataset_info = dict(
    dataset_name='apt36k',
    paper_info=dict(
        author='Yang, Yuxiang and Yang, Junjie and Xu, Yufei and '
               'Zhang, Jing and Lan, Long and Tao, Dacheng',
        title='APT-36k: '
              'A large-scale benchmark for animal pose estimation and tracking',
        container='36th Conference on Neural Information Processing Systems '
        '(NeurIPS 2022) Track on Datasets and Bench-marks.',
        year='2022',
        homepage='https://github.com/pandorgan/APT-36K',
    ),
    keypoint_info={
        0:
        dict(
    ...
    skeleton_info={
        ...
        11: dict(link=('Root of tail', 'L_Hip'), id=17, color=[0, 255, 255]),
