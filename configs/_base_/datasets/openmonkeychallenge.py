...
dataset_info = dict(
    ...
    skeleton_info={
        ...
        7: dict(link=('Neck', 'L_Shoulder'), id=6, color=[0, 255, 255]),
        8: dict(link=('L_Shoulder', 'L_Elbow'), id=7, color=[6, 156, 250]),
        9: dict(link=('L_Elbow', 'L_Wrist'), id=8, color=[6, 156, 250]),
        10: dict(link=('Neck', 'Hip'), id=9, color=[6, 156, 250]),
        11: dict(link=('Hip', 'R_Knee'), id=10, color=[0, 255, 255]),
        12: dict(link=('R_Knee', 'R_Ankle'), id=11, color=[0, 255, 255]),
        13: dict(link=('Hip', 'L_Knee'), id=12, color=[0, 255, 255]),
        14: dict(link=('L_Knee', 'L_Ankle'), id=13, color=[6, 156, 250]),
        15: dict(link=('Hip', 'Tail'), id=14, color=[6, 156, 250]),
    },
