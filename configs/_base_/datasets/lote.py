...
dataset_info = dict(
    ...
    paper_info=dict(
        ...
        title='LoTE-Animal: '
              'A Long Time-span Dataset '
              'for Endangered Animal Behavior Understanding',
        container='IEEE/CVF International Conference on Computer Vision (ICCV)',
        year='2023',
        homepage='https://lote-animal.github.io/',
    ),
    keypoint_info={
        0:
        dict(
