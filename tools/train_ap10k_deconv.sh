...
BASE_CONFIG_PATH="configs/animal_2d_keypoint/animalvitpose/ap10k_1"
 

configurations=(
    "${BASE_CONFIG_PATH}/animalvitpose-small_8xb64-210e_ap10k-256x256.py"
    "${BASE_CONFIG_PATH}/animalvitpose-base_8xb64-210e_ap10k-256x256.py"
    "${BASE_CONFIG_PATH}/animalvitpose-large_8xb64-210e_ap10k-256x256.py"
    "${BASE_CONFIG_PATH}/animalvitpose-huge_8xb64-210e_ap10k-256x256.py"
...
for config in "${configurations[@]}"; do
    ...
    work_dir="./work_dirs/animalvitpose/ap10k_1/${config_name}"
