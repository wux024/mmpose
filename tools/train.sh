...
case $MODE in
  bottomup)
    ...
    configurations=(
        ...
        "${BASE_CONFIG_PATH}/cid_hrnet-w32_8xb20-140e_${DATASET_NAME}-512x512.py"
  ...
  rtmpose)
    ...
    configurations=(
        ...
        "${BASE_CONFIG_PATH}/${MODE}-s_8xb256-420e_${DATASET_NAME}-256x192.py"
        "${BASE_CONFIG_PATH}/${MODE}-m_8xb256-420e_${DATASET_NAME}-256x192.py"
  ...
  topdown_others)
    ...
    configurations=(
        ...
        "${BASE_CONFIG_PATH}/td-reg_res50_8xb64-210e_${DATASET_NAME}-256x192.py"
        "${BASE_CONFIG_PATH}/td-reg_res50_rle-8xb64-210e_${DATASET_NAME}-256x192.py"
        "${BASE_CONFIG_PATH}/td-reg_res101_8xb64-210e_${DATASET_NAME}-256x192.py"
        "${BASE_CONFIG_PATH}/td-reg_res101_rle-8xb64-210e_${DATASET_NAME}-256x192.py"
        "${BASE_CONFIG_PATH}/td-reg_res152_8xb64-210e_${DATASET_NAME}-256x192.py"
        "${BASE_CONFIG_PATH}/td-reg_res152_rle-8xb64-210e_${DATASET_NAME}-256x192.py"
